...
static bool operator==(const Rgba& value1, const Rgba& value2) {
...
void SpotLightFallOFFIntensityCalculator::GetLightFallOffPointsfromCorePoints_UsingTableMapOfSectorsAndSegment(const Array2D<Rgba>& inputImage_, const Point2D<int>&corePoint_) {
    ...
    SectorsInImage Sector(360, SegmentInEachSector(maxNumberOfRadiusSegment,std::vector<Point2D<int>>()));
    SegmentInEachSector Segment(maxNumberOfRadiusSegment,std::vector<Point2D<int>>());
    
    IntensityInImageSectors SectorIntensity(360, IntensitySegmentInEachSector(maxNumberOfRadiusSegment, std::vector<Rgba>()));
...
//                std::cout << "block1 = " << (numberOfZeroIntensityVectorBlock1 / SectorIntensity[index][block].size()) << std::endl;
//            }
//            
//            if (Sector[index][block-1].size() > 0) {
...
//                std::cout << "block2 = " << (numberOfZeroIntensityVectorBlock2 / SectorIntensity[index][block-1].size()) << std::endl;
//            }
//            
